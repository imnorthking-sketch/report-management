          ...
          <CardContent className="p-4">
            <div className="flex items-start">
              ...
              <div className="text-sm text-blue-800 dark:text-blue-200">
                <p className="font-medium mb-1">Manager Payment Information:</p>
                <ul className="list-disc list-inside space-y-1">
                  <li>As a manager, you can complete payments without waiting for additional approval</li>
                  <li>Your payment will be processed immediately</li>
                  <li>Administrative records will be updated automatically</li>
                  <li>Users will receive payment completion notifications</li>
                </ul>
              </div>
            </div>
          </CardContent>
