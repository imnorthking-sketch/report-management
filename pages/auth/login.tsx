  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorMessage.includes('Invalid credentials')) {
        ...
        displayMessage = 'User account not found or inactive. Please contact your administrator.'
      } else if (errorMessage.includes('configuration error')) {
        displayMessage = 'Authentication system configuration error. Please contact your administrator.'
